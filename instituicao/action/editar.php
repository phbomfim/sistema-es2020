        ...
        <div class="conteudo-completo">
            ...
            <?php 
            	...
            	if (isset($_POST['i_nome'])){
            		...
            		$nome_ = $_POST['i_nome'];
        			if($nome_ != $nome){
                        $editar = "UPDATE instituicao SET nome = '$nome_' WHERE id = '$id'";
                ...
                if (isset($_POST['i_endereco'])){
                    ...
                    if($endereco_ != $endereco){
                        $editar = "UPDATE instituicao SET endereco = '$endereco_' WHERE id = '$id'";
                        if(mysqli_query($con,$editar))
                            echo"<script language='javascript' type='text/javascript'>alert('Dados atualizados!');window.location.href='../index.php';</script>";
                    }
                }
        		...
        		if (isset($_POST['i_cidade'])){
        			...
        			if($cidade_ != $cidade){
                        $editar = "UPDATE instituicao SET cidade = '$cidade_' WHERE id = '$id'";
                        if(mysqli_query($con,$editar))
                            echo"<script language='javascript' type='text/javascript'>alert('Dados atualizados!');window.location.href='../index.php';</script>";
                    }
                }
        		...
        		if (isset($_POST['i_estado'])){
        			...
        			if($estado_ != $estado){
                        $editar = "UPDATE instituicao SET estado = '$estado_' WHERE id = '$id'";
                        if(mysqli_query($con,$editar))
                            echo"<script language='javascript' type='text/javascript'>alert('Dados atualizados!');window.location.href='../index.php';</script>";
                    }      
        		}
        		...
        		if (isset($_POST['i_mec'])){
                    ...
                    $mec_ = $_POST['i_mec'];
        			if($mec_ != $mec){
                        $editar = "UPDATE instituicao SET mec = '$mec_' WHERE id = '$id'";
                        if(mysqli_query($con,$editar))
                            echo"<script language='javascript' type='text/javascript'>alert('Dados atualizados!');window.location.href='../index.php';</script>";
                    }
        		}
                ...
                if (isset($_POST['i_mantenedora'])){
                    ...
                    if($mantenedora_ != $mantenedora){
                        $editar = "UPDATE instituicao SET mantenedora = '$mantenedora_' WHERE id = '$id'";
                        if(mysqli_query($con,$editar))
                            echo"<script language='javascript' type='text/javascript'>alert('Dados atualizados!');window.location.href='../index.php';</script>";
                    }
                }
                ...
                if (isset($_POST['i_usuario'])){
                    ...
                    if($usuario_ != $usuario){
                        $editar = "UPDATE instituicao SET usuario = '$usuario_' WHERE id = '$id'";
                        if(mysqli_query($con,$editar))
                            echo"<script language='javascript' type='text/javascript'>alert('Dados atualizados!');window.location.href='../index.php';</script>";
                    }
                }
